...
// Define o remetente
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->From = "teste@ceibirajara.url.ph"; // Seu e-mail
$mail->FromName = "Ibirajara"; // Seu nome

// Define os destinatário(s)
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
$mail->AddAddress('suporte@ffctechnologies.com.br', 'Fulano da Silva');
