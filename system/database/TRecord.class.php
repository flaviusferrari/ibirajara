...
abstract class TRecord
{
    ...
    /*
     * método getEntity()
     *  retorna o nome da entidade (tablela)
     */
    ...
    public function load($id)
    {
        ...
        if ($conn = TTransaction::get())
        {
            ...
            if ($result)
            {
                // retorna os dados em forma do objeto
    ...
    /*
     * método delete()
     *  exclui um objeto da base de dados através do ID
     * @param $id = ID do objeto
     */
    public function delete($id = NULL)
    {
        // o ID é o parãmetro ou a propriedade ID
        $id = $id ? $id : $this->id;
